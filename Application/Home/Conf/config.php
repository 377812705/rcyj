 ...
 * 所有除开系统级别的前台配置
 */
$SITE_URL = "http://www.erciyuanjie.com/";
...
return array(
    ...
    'TMPL_PARSE_STRING' => array(
    	...
    	'__flash__'    => __ROOT__ . '/Public/' . MODULE_NAME . '/flash',
        '__CSS__'    => __ROOT__ . '/Public/' . MODULE_NAME . '/css',
        '__JS__'     => __ROOT__ . '/Public/' . MODULE_NAME . '/js',
    ),

    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => '2cy_home', //session前缀
    'COOKIE_PREFIX'  => '2cy_home_', // Cookie前缀 避免冲突
