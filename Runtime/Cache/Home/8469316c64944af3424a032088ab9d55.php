    ...
    <div class="edit-div">
        ...
        <ul class="login-ul">
            <li class="txt-input username">
                <input name="" type="text" value="新邮箱"  class="gray" onclick="if(this.value=='新邮箱'){this.value='';this.className='black'}" onblur="if(this.value=='') {this.value='新邮箱';this.className='gray'}">
            </li>
