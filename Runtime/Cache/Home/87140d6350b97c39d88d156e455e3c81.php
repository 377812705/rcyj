...
<body>
    ...
    <header class="container">
        ...
        <?php if((is_login() == 0)): ?><div class="header-right login-top">
            ...
            <ul>
                ...
                <li>|</li>
                <li><a href="/2ciyuanjie/Login/registerold.html">注册</a></li>
            </ul>
        </div>
            <?php else: ?>
    ...
    <div class="container content">
        <div class="custom success-content"> <img src="/2ciyuanjie/Public/Home/images/success-img02.gif"/>
            <h2>提交成功</h2>
            <h4>恭喜您，作品提交成功，感谢您在我们平台提供优秀作品让更多人能够关注到你的作品！</h4>
        </div>
        <div class="report-btn success-btn">
            <input name="" type="button" onClick="javascript:location.href='/2ciyuanjie/Index'" value="返回首页">
        </div>
    </div>
