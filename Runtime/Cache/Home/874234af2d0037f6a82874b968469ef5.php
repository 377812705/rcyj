  ...
  <div class="container content">
			<div class="custom">
				<ul class="nextnav">
								...
								<li><a href="javascript:;">作品来源</a>
									<ul class="custom-ul">
												<li class="custom-all"><a href="javascript:;">全部</a></li>
												<li class="custom-li"><a href="javascript:;">个人订制</a></li>
												<li class="custom-li"><a href="javascript:;">企业订制</a></li>
                                                <li class="custom-li"><a href="javascript:;">自创作品</a></li>
										</ul>
								</li>
                                <li><a href="javascript:;">作品主题</a>
									<ul class="custom-ul">
												<li class="custom-all"><a href="javascript:;">全部</a></li>
                                ...
                                <li class="top-btn upload"> <input name="" type="button" value="上传作品" onClick="javascript:location.href='/MyCenter/uploadWork.html'"></li>
						</ul>
					</div>
				<div class="module">
						...
						<ul>
							<?php if(is_array($works)): $i = 0; $__LIST__ = $works;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 4 );++$i;?><li style="display:block;"><a href="/Product/details/id/<?php echo ($data["id"]); ?>.html"><img src="http://www.2ciyuanjie.com/<?php echo ($data["main_image_url"]); ?>" alt="作品图片-<?php echo ($data["title"]); ?>" style="display：block;width: 293px;height: 222px;"/></a>
										...
										<h5><span><?php echo ($data["open_count"]); ?></span>人气  /<span>876</span>点赞  /<span>60</span>收藏 </h5>
