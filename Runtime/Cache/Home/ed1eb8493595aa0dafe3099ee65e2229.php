    ...
    <div class="author-content">
      <div class="module">
        ...
        <?php if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="order-left nofloat"> <span class="order-tle"><?php echo ($data["create_date"]); ?>   订单号：<?php echo ($data["order_number"]); ?></span>
	          ...
	          <div class="operating"> <span><?php echo ($paytype[$data[order_type]]); ?><a class="report-a" onclick="orderclick()" >订单详情</a></span>
      ...
      <div class="report-content order-details" style="display:none;">
        <div class="report-tle">订单详情<a href="javascript:;"><img src="/Public/Home/images/colse-btn.gif"/></a></div>
        <div class="report-main">
          <h4>当前订单状态：交易成功 <span>交易成功，请及时给作者评价。</span></h4>
          <span class="details-list">
          <h5>作者信息</h5>
          <h5>昵称：二郎神    地区：北京市</h5>
          <h5>订单号：923893743</h5>
          <h5>完成时间：2015-08-08  18：00：00</h5>
          <h5>付款时间：2015-08-08  18：00：00     确认时间：2015-08-08  18：00：00</h5>
          <span class="actually">
          <h3>实付款：<span>￥300.00</span></h3>
          </span> </span> </div>
